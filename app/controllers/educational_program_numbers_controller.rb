...
class EducationalProgramNumbersController < ApplicationController
  ...
  def educational_program_number_params
    params.require(:educational_program_number).permit(:id, :educational_program_id, :number_federal, :number_regional, :number_local, :number_personal, :number_foreign_budget, :number_foreign_paid, :date)
  end
